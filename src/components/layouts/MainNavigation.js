...
const MainNavigation = () => {
  let activeClassName =
    "block py-2 pr-4 pl-3 bg-blue-700 md:bg-transparent md:text-blue-700 md:p-0";
  ...
  return (
    <nav className="bg-white border-gray-200 px-10 sm:px-4 py-2.5 dark:bg-gray-900">
